...
const (
	...
	MsgTokenPrimaryGroupInvalid     = "token.primary_group_invalid"
	MsgTokenFallbackGroupsTooMany   = "token.fallback_groups_too_many"
	MsgTokenFallbackGroupsDuplicate = "token.fallback_groups_duplicate"
	MsgTokenFallbackGroupsInvalid   = "token.fallback_groups_invalid"
	MsgTokenFallbackGroupIsPrimary  = "token.fallback_group_is_primary"
)
