...
type ChannelOtherSettings struct {
	...
	CountTokensEnabled                    bool                  `json:"count_tokens_enabled,omitempty"`       // 是否允许免费的 token 计数端点：Anthropic 渠道对应 /v1/messages/count_tokens，OpenAI 渠道对应 /v1/responses/input_tokens
